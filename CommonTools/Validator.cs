...
// NameSpace : IECommonEntiry.Tools
// FileName : Class1
//
// Created by : XHL at 2020/6/3 10:25:04
//
// Function : 
//
//========================================================================
namespace HZZG.Common.Tolls
{
    public class Validator
    {
        ...
        /// <returns>是否匹配</returns>
        public static bool IsMatchIgnoreCase(string inputStr, string patternStr, bool ifIgnoreCase)
        {
