...
namespace HZZG.Common.Tolls
{
    ...
    public static class AesUtil
    {
        ...
        /// <returns></returns>
        public static string Encrypt(this string str, string key= DefaultPassword)
        {
            key = FmtPassword(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public static byte[] Encrypt(this byte[] array, string key= DefaultPassword)
        {
            key = FmtPassword(key);
            byte[] keyArray = Encoding.UTF8.GetBytes(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public static string Decrypt(this string str, string key= DefaultPassword)
        {
            key = FmtPassword(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public static byte[] Decrypt(this byte[] array, string key= DefaultPassword)
        {
            key = FmtPassword(key);
            byte[] keyArray = UTF8Encoding.UTF8.GetBytes(key);
        ...
        /// <returns></returns>
        public static string FmtPassword(this string s)
        {
            string password = s ?? "";
